...
public class AudioCapture implements Capture {
    ...
    public boolean start() {
        return startCapture(Constant.DEFAULT_AUDIO_RECORD_SOURCE, Constant.DEFAULT_AUDIO_SAMPLE_RATE, Constant.DEFAULT_AUDIO_CHANNEL_CONFIG, Constant.DEFAULT_AUDIO_FORMAT);
    }
