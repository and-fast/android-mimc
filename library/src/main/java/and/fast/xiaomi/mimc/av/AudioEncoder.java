...
//    private byte[] specificData;
    ...
    public boolean start() {
        return startEncoder(Constant.DEFAULT_AUDIO_SAMPLE_RATE, Constant.DEFAULT_CODEC_CHANNEL_COUNT, Constant.DEFAULT_ENCODER_BIT_RATE,
            2 * AudioRecord.getMinBufferSize(Constant.DEFAULT_AUDIO_SAMPLE_RATE, Constant.DEFAULT_AUDIO_CHANNEL_CONFIG, Constant.DEFAULT_AUDIO_FORMAT));
    }
